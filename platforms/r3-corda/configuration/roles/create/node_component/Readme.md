...
#### Note:
 Var folder has environment variable for node_component role. Templates folder has tpl files for h2, node and job. Any change to be reflected in the final value file then these tpl files inside template folder needs to be updated accordingly.